...
public abstract class EUExBase {
	 ...
	 *            目标Intent
	 * @param requestCode
	 *            你为目标Activity分配的请求码,大于0的int型数据,将在onActivityResult时返回.
	 */
	 ...
	 * @param resultCode
	 *            目标Activity finish时设置的状态码.如RESULT_OK = -1,RESULT_CANCELED =
	 *            0等等.
	 * @param data
	 *            目标Activity finish时返回的数据.
	 */
	 ...
	 * 
	 * @param inWindowName
	 *            window的name，如果是当前window，传null或者""。
	 * @param type
	 *            window中的main/slibing。
	 * @param inScript
	 *            将要执行的脚本。
	 */
